...
minPath matrix _ (0,0) = pure $ matrix !! 0 !! 0
minPath matrix f (i,0) = liftM (matrix !! i !! 0 +) (f (i-1,0))
minPath matrix f (0,j) = liftM (matrix !! 0 !! j +) (f (0,j-1))
minPath matrix f (i,j) = liftM (matrix !! i !! j +) (liftM2 min left top)
